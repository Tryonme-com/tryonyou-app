"""
Re-export de resolucion Stripe FR (cuenta Paris).

Carga el modulo raiz ``stripe_fr_resolve.py`` por ruta absoluta para evitar
import circular cuando ``api/`` precede a la raiz en ``sys.path``.
