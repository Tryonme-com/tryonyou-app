...
class TestSupercommitMaxStaticGuards(unittest.TestCase):
    ...
    def test_galerie_oberkampf_marker(self) -> None:
        catalogue = (ROOT / "client/src/pages/Catalogue.tsx").read_text(encoding="utf-8")
        self.assertIn('data-bunker="oberkampf-75011"', catalogue)
        self.assertIn("75011", catalogue)
